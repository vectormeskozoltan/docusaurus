...
const config = {
  title: 'Állatos Docusaurus',
  tagline: 'mindenféle állatság előfordulhat itt',
  ...
  themes: ['docusaurus-theme-openapi-docs'],//ez a vége második beillesztésnek
